...
* [CLI contribute — hooks renommés localement](cli-contribute-renamed-files.md) - contribute échouait en ENOENT quand l'utilisateur renommait un hook .mjs installé : la copie partait de <slug>.mjs au lieu du fichier réel portant le fingerprint.
