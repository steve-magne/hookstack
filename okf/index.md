...
* [CLI install — audit détection + UX](implementation/cli-install-detection-ux.md) - Toolchain inconnue → hooks universels seuls ; slugs écartés listés ; 3 gardes SEO Next.js-only sorties du default_on et rattachées au signal nextjs ; spinner/log + spinner de détection. E2E PTY + 4 scénarios scratch.
