    ...
    (
      <div
        style={{
          ...
          padding: '90px',
          background: 'linear-gradient(135deg, #0b0b12 0%, #1a1635 60%, #2a1f57 100%)',
          color: 'white',
      ...
      >
        ...
        <div style={{ display: 'flex', fontSize: 42, marginTop: 18, color: '#a5b4fc' }}>
          Agentic Hooks for Claude Code
        </div>
        <div style={{ display: 'flex', fontSize: 28, marginTop: 40, color: '#a1a1aa' }}>
