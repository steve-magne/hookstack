...
export function InstallCommand({
	...
	return (
		<div
			data-component="InstallCommand"
			className="overflow-hidden rounded-xl border border-zinc-700/70 bg-[#0c0c12] shadow-lg shadow-black/40"
		>
			{/* InstallCommand-chrome — feux macOS + label + slot meta */}
			<div
				data-component="InstallCommand-chrome"
				className="flex items-center gap-2 border-b border-white/5 bg-white/[0.015] px-3.5 py-2"
			>
			...
			<div
				data-component="InstallCommand-body"
