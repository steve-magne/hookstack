...
const BEATS: Beat[] = [
	...
	},
	{
		...
		hooks:
			"post-write-autoformat · post-write-biome · post-edit-typecheck · pre-write-secret-detection",
		tone: "neutral",
	},
	{
		ev: "Stop",
				...
				<div className="mx-auto w-full max-w-5xl px-4">
					...
					<div className="mb-8 text-center">
						<p className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-widest text-zinc-500">
							<Sparkles className="size-3.5" aria-hidden /> What hooks actually
							do
						</p>
						...
						<p className="mx-auto mt-3 max-w-2xl text-pretty text-sm leading-relaxed text-zinc-400 sm:text-base">
							...
							<em className="not-italic text-zinc-300">before</em> risky
							actions, automation{" "}
							<em className="not-italic text-zinc-300">after</em>. Scroll
							through one feature shipping under their watch.
						</p>
					</div>
						...
						>
							...
							>
								...
								<m.line
									...
									initial={false}
									animate={{
										stroke: s >= 1 ? "rgba(251,191,36,0.45)" : "#272727",
									}}
...
function Proof({ step }: { step: number }) {
	const box =
		"flex h-[88px] w-full items-center justify-center rounded-xl bg-[var(--color-surface-2)] px-4 ring-1 ring-inset ring-white/5 sm:w-64";
		...
		return (
			<div className={box}>
				<div className="w-full">
					...
					<p className="text-center font-mono text-[11px] text-emerald-300">
						✓ 18 passed
					</p>
				</div>
			</div>
